...
language: # optional
  $language-frazes$          # See language section for more information
```
...
This property will contain an array of string the module requires to translate. A module that have required the language files,
