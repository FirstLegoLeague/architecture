...
1. `executable` - the executable for running the module process. This field is getting two possible types
   1. a string represent the executable path
   2. an object represent the executables paths for each operating system
1. `arguments` (optional) - an array of the arguments should be passed to the script when starting the script
